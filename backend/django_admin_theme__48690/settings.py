"""
Django settings for django_admin_theme__48690 project.
...
ROOT_URLCONF = 'django_admin_theme__48690.urls'
...
WSGI_APPLICATION = 'django_admin_theme__48690.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "django_admin_theme__48690 API",
    "DESCRIPTION": "API documentation for django_admin_theme__48690 App",
    "VERSION": "v1",
}
...
JET_SIDE_MENU_COMPACT = env.bool("JET_SIDE_MENU_COMPACT", default=False)
